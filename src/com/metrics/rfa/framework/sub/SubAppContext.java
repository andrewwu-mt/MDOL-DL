...
public abstract class SubAppContext implements Client
{
    static public void addCommandLineOptions()
    {
        ...
        CommandLine.addOption("serviceName", "", "service to request");
        CommandLine.addOption("session", "", "Session name to use");
        ...
        CommandLine.addOption("fileDictionary", true, "load dictionary from file");
        CommandLine.addOption("enumType", "", "enumtype.def filename");
        CommandLine.addOption("type", "OMM", "type of sub connection (OMM | MarketData)");
        //CommandLine.addOption("type", "MarketData", "type of sub connection (OMM | MarketData)");
        //CommandLine.addOption("itemNames", "JPY=", "split by ,");
        //CommandLine.addOption("itemNames", "N2_UBMS", "split by ,");
        //CommandLine.addOption("fieldNames", "DSPLY_NAME,TRDPRC_1,NETCHNG_1,ACVOL_1,BID,ASK", "split by ,");
